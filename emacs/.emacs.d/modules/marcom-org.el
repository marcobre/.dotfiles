...
(use-package org
  ...
  (defvar my/org-contacts-template "* %(org-contacts-template-name)
         :PROPERTIES:
         :ADDRESS: %^{Musterstrasse 15, 13187 Berlin, DE}
         :BIRTHDAY: %^{Birthday}
...
;; Org Hydra
(pretty-hydra-define mb-toggles
  ...
  ("Basic"
   ...
   (("d" jp-themes-toggle-light-dark "dark theme" :toggle jp-current-theme-dark-p)
    ("v" visual-fill-column-mode "Visual Fill" :toggle t))
   "Coding"
...
(pretty-hydra-define mb-gtd-menue
  (:color amaranth :quit-key "q")
  ("Navigate"
   (("a" org-archive-subtree "Archive")
    ("d" org-cut-subtree "Delete")
    ("c" mb-clocking/body "Clocking" ))
   "Refile"
   (("t" refile-to-task "Tasks")
    
    ("r" org-refile "refile"))))

(pretty-hydra-define mb-clocking
  (:color green :quit-key "q")
  ("IN/OUT"
   (("i" org-clock-in "In")
